    ...
    <>
      <header className="px-10 py-5 md:flex justify-between md:mt-14 xs:mt-5">
        ...
        <div className="relative w-full xs:mt-0">
          <img
            className="object-contain w-full h-full absolute xs:top-12 xs:right-0 sm:right-1 z-0"
            src={backdrop}
            alt="Backdrop"
          />
          <img
            className="object-contain w-full h-96 relative sm:bottom-6 xs:bottom-6 xs:right-0 sm:right-2 md:-right-1 z-10"
            src={my_image}
            alt="My Image"
          />
        </div>
